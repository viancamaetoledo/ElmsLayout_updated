        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || username.isEmpty() || password.isEmpty()) {
                    Toast.makeText(addTeacher.this, "All fields are required", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (selectedProgram.isEmpty()) {
                    Toast.makeText(addTeacher.this, "Please select a program", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (selectedYear.isEmpty()) {
                    Toast.makeText(addTeacher.this, "Please select a year", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                roleReference.child(username).setValue(helperClass)
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(addTeacher.this, "User added successfully as " + role, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(addTeacher.this, Admin_Dashboard.class);
                            startActivity(intent);
                        })
                        .addOnFailureListener(e -> Toast.makeText(addTeacher.this, "Failed to add user. Try again.", Toast.LENGTH_SHORT).show());
            }
        });
    }
