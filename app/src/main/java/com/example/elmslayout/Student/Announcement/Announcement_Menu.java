package com.example.elmslayout.Student.Announcement;
...
public class Announcement_Menu extends AppCompatActivity {
    ...
    private void fetchSubjects(String name) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (datalist.isEmpty()) {
                    Toast.makeText(Announcement_Menu.this, "No subjects found for " + name, Toast.LENGTH_SHORT).show();
                }
            }
